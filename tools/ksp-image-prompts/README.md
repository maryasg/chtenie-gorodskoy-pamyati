...
- Скрипты и инструкции ниже — копируются в папку статей через `СКОПИРОВАТЬ_В_СТАТЬИ.bat` (включая `generate.py`, `docx_export.py`, `export_docx.bat`, `pack_month.bat`, `ИНСТРУКЦИЯ_ДЛЯ_ПЕЧАТИ.md`)
