...
1. Вкладка **«1. Источники»** → таблица **«Сравнения»** внизу
2. **«Создать новое…»** — название, пара фото
3. **«Сделать текущим ★»** — с этого сравнения идут углы, выпрямление, разметка, экспорт
4. Лишние пустые `cmp_XXX` (0 разметок) — **«Пометить к удалению»** → **«Удалить помеченные…»**
