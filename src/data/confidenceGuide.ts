...
export const CONFIDENCE_LEVELS: ConfidenceLevelInfo[] = [
  ...
  },
  {
    ...
    hint: 'Сильная аргументация по источникам, но без прямой строчки в акте по этой зоне.',
    sourceTiers: 'Средний',
    sourceExamples:
      'Научные статьи и монографии; качественная реставрационная журналистика + полевая съёмка',
