...
export const ARCHIVIEW_ASSETS: Record<string, ArchiviewBuildingAssets> = {
  MOSCOW_001_kumaninykh: {
    ...
    cardId: 'MOSCOW_001',
    markedFacadeUrl: `${base}explorer/MOSCOW_001/comparisons/cmp_005/marked-facade.png`,
    labeledFacadeUrl: `${base}explorer/MOSCOW_001/comparisons/cmp_005/marked-facade-labeled.png`,
    labelingLayout: 'overlay',
    historicalRectifiedUrl: `${base}explorer/MOSCOW_001/comparisons/cmp_005/historical-rectified.png`,
    modernRectifiedUrl: `${base}explorer/MOSCOW_001/comparisons/cmp_005/modern-rectified.png`,
    modernSourceUrl: `${base}explorer/MOSCOW_001/comparisons/cmp_005/modern-source.png`,
    historicalPhotoYear: '1930',
    modernPhotoYear: '2026',
    annotationsUrl: `${base}explorer/MOSCOW_001/comparisons/cmp_005/annotations.json`,
    facadeProjectUrl: `${base}explorer/MOSCOW_001/comparisons/cmp_005/facade-project.json`,
    comparisonId: 'cmp_005',
    comparisonTitle: '1930 → 2026',
  },
