...
export const MOSCOW_003: Building = {
  ...
  memoryTraces: [
    ...
    },
    {
      ...
      title: 'Утраченная декоративная решётка',
      period: 'уточняется',
      confidence: 'needs_verification',
      userMessage:
        'Зона относится к утраченной декоративной решётке. Точную датировку, описание и источник нужно уточнить куратору перед публикацией.',
    },
  ],
  artifacts: [
    {
