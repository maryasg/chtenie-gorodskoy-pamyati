...
export const MOSCOW_003: Building = {
  ...
  memoryTraces: [
    ...
    },
    {
      ...
      userMessage:
        'Балкон дореволюционного дома на левой части фасада демонтирован при реконструкции и надстройке. На довоенных фотографиях балконы с кованым ограждением читаются отчётливее.\n\nИсточник: фото ~1911 (PastVu); съёмка 2026 (Archiview).',
    },
    {
      id: 'MOSCOW_003_T005',
    ...
    },
    {
      ...
      userMessage:
        'На исторических снимках над карнизом верхнего дореволюционного яруса виден ажурный декоративный пояс. При надстройке 1945 года элемент снят; на фото PastVu (~1911) он читается отчётливее.\n\nИсточник: фото ~1911 (PastVu); съёмка 2026 (Archiview).',
    },
    {
      id: 'MOSCOW_003_T008',
    ...
    },
    {
      ...
      userMessage:
        'Балконный объём на уровне 5–6 этажа не входил в первоначальный проект Л. Кравецкого. Вероятно появился при надстройке или в послевоенных переделках; датировку уточняют архивные снимки.\n\nИсточник: фото ~1911 (PastVu); съёмка 2026 (Archiview).',
    },
    {
      id: 'MOSCOW_003_T012',
      type: 'new_window',
    ...
    },
    {
      ...
      userMessage:
        'Дополнительный объём на правом торце фасада. Точная датировка и назначение пристройки уточняются по акту историко-культурной экспертизы и архивным материалам.\n\nИсточник: акт историко-культурной экспертизы (mos.ru, 2019) — датировка уточняется.',
    },
    {
      id: 'MOSCOW_003_T016',
      type: 'lost_balcony',
      ...
      overallConfidence: 0.85,
      userMessage:
        'Балкон дореволюционного дома на этом участке фасада демонтирован при реконструкции и надстройке. На довоенных фотографиях балконы с кованым ограждением читаются отчётливее.\n\nИсточник: фото ~1911 (PastVu); съёмка 2026 (Archiview).',
    },
  ],
  artifacts: [
    {
