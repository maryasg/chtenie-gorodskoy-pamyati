...
const DEMO_CASES = [
  ...
  },
  {
    ...
    text: 'Side-by-side показывает разные ракурсы: на фото 1989 размечено место вывески Фалькевича, а в 2026 видны восстановленные вывесочные слои.',
  },
]
    ...
    <div className="space-y-6">
      <header className="arch-section overflow-hidden border-arch-green/20 bg-gradient-to-br from-arch-green-deep to-arch-green text-arch-surface">
        ...
        <p className="mt-4 max-w-3xl text-sm leading-relaxed text-arch-surface/85">
          Проект соединяет кураторское чтение архитектуры, подготовку фотоматериалов в Archiview и
