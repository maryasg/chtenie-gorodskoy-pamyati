...
const MOSCOW_003_PREFS: CardBadgePrefs = {
  ...
  fixedBadge: {
    1: { x: 50.5, y: 71.5 },
    /** Центр окна (стрелка влево) */
    2: { x: 43, y: 69 },
    /** Верхнее окно надстройки (стрелка вверх-вправо) */
    3: { x: 63, y: 40 },
    /** Правое окно (стрелка вверх-вправо) */
    4: { x: 76, y: 40 },
    5: { x: 66.5, y: 45 },
    /** Шов / левый верх (стрелка вниз от зелёной полосы) */
    6: { x: 33, y: 43.5 },
    /** Окно на шве (двойная стрелка — к проёму) */
    7: { x: 17, y: 49 },
    8: { x: 24, y: 45 },
    9: { x: 23.5, y: 38.5 },
    /** Дверь / балкон (стрелка вверх) */
    10: { x: 40, y: 62 },
    /** Центр двери (стрелка влево) */
    11: { x: 44, y: 71 },
    12: { x: 42, y: 33 },
    13: { x: 65.5, y: 46 },
    14: { x: 73.5, y: 47 },
